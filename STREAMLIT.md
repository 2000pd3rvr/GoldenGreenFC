# Golden Green SC — Streamlit Community Cloud

GitHub-connected Streamlit description app for crawlers and reviewers.

- Entrypoint: `streamlit_app.py`
- Live interactive demo: https://huggingface.co/spaces/0001AMA/GoldenGreenFC
- Repository: https://github.com/2000pd3rvr/GoldenGreenFC
...
3. Create app → repository `2000pd3rvr/GoldenGreenFC` → branch `main` → main file `streamlit_app.py`
4. Deploy
